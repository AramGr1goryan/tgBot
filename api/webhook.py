...
async def cmd_sendupdate(message: types.Message):
    ...
    text = (
        "🚀 **Բոտի նոր թարմացում (V2.5)**\n\n"
        "Ողջույն բոլորին: Բոտում ավելացվել են նոր հնարավորություններ և կատարվել են կարևոր օպտիմիզացիաներ:\n\n"
        "🆕 **Նոր հրամաններ՝ /addprob և /addprobk**\n"
        "Այժմ դուք կարող եք գրանցել աշակերտներին փորձնական դասերի (խմբային կամ անհատական) անմիջապես բոտից՝\n"
        "👉 `/addprob <հեռ.> <mk/lg> <օր.ամիս> <ժամ>` — Խմբային փորձնական (Գ. Նժդեհ)\n"
        "👉 `/addprobk <հեռ.> <mk/lg> <օր.ամիս> <ժամ>` — Անհատական փորձնական (Կոմիտաս)\n\n"
        "⚡ **Օպտիմիզացիա և արագագործության բարելավում**\n"
        "Բոտի աշխատանքը զգալիորեն արագացվել է, բարելավվել է սխալների մշակումը: Հարցումները կատարվում են ավելի արագ, իսկ սխալների դեպքում բոտը հայտնում է հստակ պատճառը:\n\n"
        "🛠 **Այլ փոփոխություններ**\n"
        "Թարմացվել են /about և /help հրամանները նոր գործառույթներին ծանոթանալու համար:\n\n"
        "rus --- >\n\n"
