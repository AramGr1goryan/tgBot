...
async def cmd_about(message: types.Message):
    await message.answer(
        ...
        "Այս բոտը ստեղծված է RobixLab-ի աշխատանքներն ավտոմատացնելու և ավելի արագ դարձնելու համար։ Այն ստեղծվել է միակ ու անկրկնելի, մի հրաշք, բայց միևնույն ժամանակ հասարակ մահկանացու՝ Արամ Գրիգորյանի կողմից։ Յանի իմ բոտն ա, ինչ ուզում եմ՝ կգրեմ, դեմ չեք, չէ՞ \n\n"
        "🏢 **Մենեջերների և Ադմինների համար**\n"
        "🔹 Վճարումների ավտոմատ գրանցում խմբում (կանխիկ, քարտ, տերմինալ):\n"
        "🔹 Առաջադրանքների (Task) ստեղծում, վերահսկում և կատարված նշելու համակարգ:\n"
        "🔹 Օգտատերերի կառավարում (արգելափակել/ապաարգելափակել):\n\n"
        "📞 **Վաճառքի բաժնի համար (Sales)**\n"
        "🔹 Գարեգին Նժդեհ մասնաճյուղի փորձնական դասերի գրաֆիկի դիտում:\n"
        "🔹 Alfa CRM-ի հետ ուղիղ կապ. ցույց է տալիս գրանցված մասնակիցներին (Անուն, Հեռախոսահամար, CRM անկետա) և ազատ տեղերը:\n\n"
        "👨‍🏫 **Ուսուցիչների համար**\n"
        "🔹 Lego խմբերի համար բաց թեմաների ցուցակի կառավարում (տեսնել հասանելիները, ջնջել անցածները):\n\n"
        "Ամբողջական հրամանների ցանկը տեսնելու համար գրեք /help։",
        parse_mode="Markdown"
    )
...
async def cmd_help(message: types.Message):
    await message.answer(
        ...
        "🏢 **Մենեջերների և Ադմինների համար**\n"
        "📝 **Վճարումներ՝** Գրեք տեքստով (օրինակ՝ `Aram Grigoryan 50000 N`)\n"
        ...
        "📞 **Վաճառքի բաժնի համար (Sales / Alfa CRM)**\n"
        "/prob - Այսօրվա հիմնական գրաֆիկը (առանց CRM-ի)\n"
        "/proball - Շաբաթվա հիմնական գրաֆիկը (առանց CRM-ի)\n"
        "/getprob - Շաբաթվա գրանցվածները (Անուն, հեռախոս, անկետա)\n"
        "/getweek - Շաբաթվա գրանցվածների քանակները\n"
        "/freeprob - Շաբաթվա ազատ տեղերը փորձնականների համար\n\n"
        "👨‍🏫 **Ուսուցիչների համար**\n"
        "/lego [խումբ] - Տեսնել խմբի բաց թեմաները (օրինակ՝ /lego Spider man)",
        parse_mode="Markdown"
    )
